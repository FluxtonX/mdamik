...
class AuthLoginView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const _AuthLoginScaffold();
  }
}

class _AuthLoginScaffold extends StatelessWidget {
  const _AuthLoginScaffold();

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<AuthLoginViewModel>(
      viewModelBuilder: () => AuthLoginViewModel(),
